...
const MOCK_FEATURES = [
  ...
  { label: 'Flashcards (202 cards)', included: false },
  ...
  { label: 'Scenario Justification (81 questions)', included: false },
...
const COMPLETE_FEATURES = [
  ...
  { label: 'Detailed answer explanations', included: true },
  { label: 'Unlimited retakes', included: true },
  { label: 'Flashcards (202 cards)', included: true },
  ...
  { label: 'Scenario Justification (81 questions)', included: true },
  { label: 'Case Study Exam (175 questions)', included: true },
  { label: 'Daily Practice (adaptive sessions)', included: true },
];

const TOOLS = [
  { icon: Layers, label: 'Flashcards', count: '202 cards', color: 'text-violet-600' },
  ...
  { icon: Brain, label: 'Scenario Justification', count: '81 questions', color: 'text-teal-800' },
      ...
      <div className="container py-12 md:py-16 max-w-5xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-sm text-muted-foreground text-center mb-6">
            8 tools, 800+ practice items, all mapped to the BACB 6th Edition Task Content Outline.
          </p>
