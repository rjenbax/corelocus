...
export const tier6Pool_I_easy: Question[] = [
...

  {
    ...
    choices: [
      ...
      { letter: "C", text: `Effective feedback focuses primarily on the supervisee's strengths and positive performance to maintain motivation and a positive supervisory relationship, with performance deficits addressed only during formal annual evaluations to avoid undermining the supervisee's confidence.` },
      { letter: "D", text: `Effective feedback is delivered privately in written form to avoid embarrassing the supervisee in front of colleagues or clients, and should be provided no more than once per week to prevent the supervisee from feeling micromanaged.` },
    ],
    correctAnswer: "A",
