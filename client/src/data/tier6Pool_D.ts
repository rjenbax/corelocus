...
export const tier6Pool_D: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: "D",
    rationale: "The correct answer is A. The graph shows that the student's performance (blue circles) consistently meets or exceeds each new criterion level (orange diamonds) as it is introduced. For example, when the criterion shifts from 5 to 10, the student's performance quickly rises to meet it. When it shifts to 15, performance again meets it, and so on. This close tracking of the criterion demonstrates a strong functional relationship and experimental control. Choice B is incorrect because the student is successfully meeting each criterion step, indicating the step sizes are appropriate, not too large. Choice C is incorrect because the student does reliably meet and often exceeds the criteria, showing good control. Choice D is incorrect because while there are only three data points before the first criterion change, the initial performance is stable and low (5-7 problems), which is sufficient to show a clear increase when the first criterion of 10 is introduced.",
  },
  {
    id: "t6-D-pool-13",
    domain: "D",
