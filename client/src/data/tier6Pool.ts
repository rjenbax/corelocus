...
const poolByDomain: Record<string, Question[]> = {
  A: [...tier6Pool_A, ...tier6Questions.filter(q => q.domain === 'A')],
  B: [...tier6Pool_B, ...tier6Questions.filter(q => q.domain === 'B')],
  C: [...tier6Pool_C, ...tier6Questions.filter(q => q.domain === 'C')],
  D: [...tier6Pool_D, ...tier6Questions.filter(q => q.domain === 'D')],
  E: [...tier6Pool_E, ...tier6Questions.filter(q => q.domain === 'E')],
  F: [...tier6Pool_F, ...tier6Questions.filter(q => q.domain === 'F')],
  G: [...tier6Pool_G, ...tier6Questions.filter(q => q.domain === 'G')],
  H: [...tier6Pool_H, ...tier6Questions.filter(q => q.domain === 'H')],
  I: [...tier6Pool_I, ...tier6Questions.filter(q => q.domain === 'I')],
};
