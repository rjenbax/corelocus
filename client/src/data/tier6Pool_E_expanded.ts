...
export const tier6Pool_E_expanded: Question[] = [
...

  {
    ...
    choices: [
      { letter: "A", text: `Accept the massage because it is a service exchange rather than a monetary payment, and the BACB Ethics Code does not prohibit all forms of non-monetary compensation from caregivers.` },
      { letter: "B", text: `Decline the offer, explaining that accepting personal services from a client's family member creates a multiple relationship that could compromise the BCBA's objectivity and the therapeutic relationship.` },
    ...
    correctAnswer: "B",
    rationale: `Choice B is correct. The BACB Ethics Code requires BCBAs to avoid multiple relationships that could impair their objectivity or harm the client. Accepting a personal service from a client's parent — regardless of whether it is monetary — creates a dual relationship that blurs the professional boundary between the BCBA and the family. Choice A is incorrect because the prohibition on multiple relationships is not limited to monetary transactions; non-monetary exchanges can equally compromise professional objectivity. Choice C is incorrect because secrecy does not resolve the ethical problem and may compound it by creating an undisclosed arrangement. Choice D is incorrect because while consultation is a sound general practice, the appropriate action here is to decline the offer; consultation does not make an ethically problematic arrangement acceptable.`,
  },
...

  {
    ...
    choices: [
      { letter: "A", text: `Sign off on the hours because text-based check-ins constitute a form of ongoing supervisory contact, and the BACB does not specify the precise modality required for all supervision interactions.` },
      { letter: "B", text: `Decline to sign off on the hours for the two weeks in question, explain to the employer that the contact during that period did not meet BACB supervision requirements, and work with the candidate to make up the required hours.` },
...

  {
    ...
    choices: [
      { letter: "A", text: `The BCBA may reduce supervision for the experienced RBT below the minimum requirement because the BACB minimum is a floor designed for new practitioners, and experienced practitioners with demonstrated competence require less oversight.` },
      { letter: "B", text: `The BCBA must maintain supervision at or above the BACB minimum requirement for all RBTs regardless of experience level, and should seek additional resources or adjust caseloads to meet the newer RBT's needs without reducing the experienced RBT's required supervision.` },
    ...
    correctAnswer: "B",
    rationale: `Choice B is correct. The BACB minimum supervision requirements apply to all RBTs regardless of experience level or performance history. The BCBA's ethical obligation is to maintain required supervision for all supervisees while also finding ways to meet the newer RBT's additional needs — for example, by adjusting caseloads, seeking additional supervisory support, or discussing resource allocation with clinic administration. Choice A is incorrect because the BACB minimum is not waivable based on practitioner experience; it is a regulatory floor that applies universally. Choice C is incorrect because there is no BACB provision allowing temporary reductions below minimum requirements with written consent; such a provision does not exist. Choice D is incorrect because the BACB does not have "flexibility provisions" that allow clinics to grant exceptions to minimum supervision requirements based on performance records.`,
  },
...

  {
    ...
    choices: [
      { letter: "A", text: `Obtain informed consent from both parents because both are involved in the child's life, and including both parents in the consent process reflects best practice for family-centered care regardless of custody arrangements.` },
      { letter: "B", text: `Obtain informed consent from the father as the sole legal custodian, and explain to the mother that while her involvement in treatment is welcome, only the legal custodian has the authority to provide consent for services and receive confidential records.` },
    ...
    correctAnswer: "B",
    rationale: `Choice B is correct. Informed consent for a minor's services must be obtained from the individual with legal authority to consent — in this case, the father as the sole legal custodian. The mother's visitation rights do not confer legal authority to consent to treatment or to receive confidential records without the legal custodian's authorization. The BCBA should explain this clearly to the mother while remaining respectful of her role in the child's life. Choice A is incorrect because including both parents in the consent process when only one holds legal custody could create legal and ethical complications, including unauthorized disclosure of confidential information. Choice C is incorrect for the same reason — obtaining consent from a non-custodial parent does not have legal validity and may expose the BCBA to liability. Choice D is incorrect because the custody documentation itself is sufficient to determine who has consent authority; deferring services while awaiting legal consultation is not warranted in a straightforward custody situation.`,
  },

  {
    ...
    choices: [
      { letter: "A", text: `Proceed with implementing the response cost procedure because the parents signed a general consent for ABA services at intake, which covers all behavior intervention procedures used within the scope of ABA practice.` },
      { letter: "B", text: `Obtain specific informed consent for the response cost procedure in the parents' primary language, ensuring they understand the procedure, its rationale, potential risks and benefits, and their right to withdraw consent at any time.` },
...

  {
    ...
    choices: [
      { letter: "A", text: `Continue the behavior plan as directed by the group home administrator, who is the legally authorized representative and whose consent supersedes the client's verbal objection.` },
      { letter: "B", text: `Pause implementation of the behavior plan, advocate for the client's right to assent and self-determination, and work with the treatment team and the client's legal guardian (if different from the administrator) to resolve the conflict in a manner that respects the client's dignity and preferences.` },
...

  {
    ...
    question: `Which of the following is the most appropriate response?`,
    choices: [
      { letter: "A", text: `Begin services immediately given the family's crisis situation, and complete the consent paperwork at the next scheduled session when the family is less distressed.` },
      { letter: "B", text: `Explain to the family that informed consent must be obtained before services begin, offer to complete the consent process as efficiently as possible during the current meeting, and provide crisis resources for immediate support while consent is being finalized.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Obtain specific informed consent from the parents for the behavior intervention procedures before implementation, ensuring they understand the specific techniques to be used, the rationale, and their right to request modifications.` },
      { letter: "C", text: `Implement the plan as directed by the school district, which holds educational authority over the student during school hours, and inform the parents of the specific procedures at the next IEP meeting.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Conduct a functional behavior assessment, develop a behavior support plan that prioritizes reinforcement-based and antecedent-based strategies, and implement the least restrictive effective procedures before considering whether the contingent exercise component is warranted.` },
      { letter: "C", text: `Remove the contingent exercise procedure immediately and replace it with a differential reinforcement procedure, because punishment-based procedures are never appropriate as primary interventions.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Report the observation to the appropriate child protective services agency because BCBAs are mandated reporters in most jurisdictions, and the standard for reporting is reasonable suspicion — not certainty — that abuse or neglect may have occurred.` },
      { letter: "C", text: `Consult with the BCBA's supervisor and the agency's legal counsel before making a report, to ensure that the report is warranted and to protect the agency from potential liability if the report proves unfounded.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Report the concern through the appropriate channels — including the agency's compliance process and, if the agency fails to address it, to the BACB — because falsifying records is a serious Ethics Code violation that harms clients and the profession.` },
      { letter: "C", text: `Confront the other BCBA directly and give her an opportunity to correct the records before escalating the concern, because direct resolution is preferable to formal reporting when possible.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Consult with an attorney, notify the client's mother of the subpoena, and seek a protective order or written authorization before disclosing records, because a subpoena alone does not override confidentiality protections without client consent or a court order compelling disclosure.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Intervene immediately to stop the unsafe restraint, ensure the client's safety, and report the incident to the appropriate supervisory and administrative personnel within the facility as well as to any required external regulatory bodies.` },
      ...
      { letter: "D", text: `Approach the staff member privately after the incident and explain the correct restraint protocol, giving the staff member an opportunity to correct the behavior before escalating to a formal report.` },
    ],
    correctAnswer: "B",
    rationale: `Choice B is correct. When a BCBA observes an unsafe practice that poses immediate risk of harm to a client, the ethical obligation is to intervene immediately to protect the client and then report the incident through all appropriate channels — including internal supervisory channels and any external regulatory bodies (such as a state licensing board or adult protective services) that require reporting of restraint incidents. The BCBA's ethical obligation to protect client welfare applies regardless of whether the client is on the BCBA's caseload. Choice A is incorrect because delegating the report to the primary behavior analyst does not fulfill the BCBA's independent obligation to protect client welfare and report unsafe practices. Choice C is incorrect because while HR involvement may be appropriate, it does not substitute for reporting to supervisory personnel and required external bodies. Choice D is incorrect because privately coaching the staff member after an unsafe incident fails to address the immediate reporting obligation and may allow the unsafe practice to continue.`,
  },

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Document the specific inconsistencies observed, report the concern through the agency's compliance or ethics reporting process, and if the agency fails to investigate or address the concern, report to the BACB and relevant regulatory authorities.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Decline the arrangement because receiving financial compensation for endorsing a specific product to clients creates a conflict of interest that could compromise the BCBA's objectivity and the integrity of clinical recommendations.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Disclose the ownership interest to the client's family and the agency, provide information about multiple social skills training options in the community, and allow the family to make an independent decision without the BCBA advocating for any particular program.` },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Disclose the conflict of interest to the committee chair and recuse herself from all aspects of the evaluation and selection process involving her spouse's company.` },
      ...
      { letter: "D", text: `Resign from the committee to avoid any appearance of a conflict of interest, because the financial relationship with her spouse means she cannot participate in any aspect of the procurement process.` },
    ],
    correctAnswer: "B",
    rationale: `Choice B is correct. The BCBA has a direct conflict of interest — her spouse's company stands to benefit financially from the committee's decision. The appropriate response is full disclosure to the committee chair and complete recusal from all aspects of the evaluation involving her spouse's company. This protects the integrity of the selection process and the BCBA's professional standing. Choice A is incorrect because recusing only from the final vote is insufficient; the BCBA's participation in the evaluation process (reviewing materials, discussing options, influencing other committee members) could still be affected by her conflict of interest. Choice C is incorrect because the conflict of interest is not resolved by the BCBA's good intentions; the appearance of bias and the potential for actual bias require recusal. Choice D is incorrect because resigning from the committee entirely is not necessary; full disclosure and recusal from the relevant portions of the process is the appropriate and proportionate response.`,
  },
...

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Advocate for the client by preparing a comprehensive appeal that includes objective data demonstrating continued progress, functional need, and the clinical rationale for continued services, and support the family in navigating the appeals process.` },
      ...
      { letter: "D", text: `Refer the family to a patient advocacy organization and step back from the appeals process, because insurance disputes are a legal matter that requires professional advocacy expertise beyond the BCBA's training.` },
    ],
    correctAnswer: "B",
    rationale: `Choice B is correct. The BACB Ethics Code includes an obligation to advocate for clients' access to appropriate services. When a client's services are denied despite documented clinical need, the BCBA has an ethical obligation to support the family in appealing the decision by providing objective data and clinical rationale. This is a core component of the BCBA's professional role. Choice A is incorrect because accepting an insurance denial without advocacy when the BCBA has data supporting continued need fails to fulfill the advocacy obligation. Choice C is incorrect because providing services without authorization exposes the BCBA and the agency to legal and financial liability; advocacy through the appeals process is the appropriate response. Choice D is incorrect because while referral to advocacy organizations can be a helpful supplement, the BCBA's own expertise in documenting clinical need and progress is directly relevant to the appeal and should not be withheld.`,
  },

  {
    ...
    choices: [
      ...
      { letter: "B", text: `Participate in the public comment process, provide testimony or written comments based on the scientific evidence supporting FCT, collaborate with professional organizations to advocate against the regulation, and educate policymakers about the potential harm to clients.` },
