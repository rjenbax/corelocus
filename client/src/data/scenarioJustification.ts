    ...
    questions: [
      ...
      },
      {
        ...
        justifications: [
          ...
          { id: 'j6', text: 'Parsimony is the same as empirical support — the most parsimonious explanation always has the most research behind it.', isCorrect: false, justifiesChoice: 'D' },
    ...
    questions: [
      {
        ...
        justifications: [
          ...
          { id: 'j4', text: 'Sharing immediately is appropriate because treating providers always have the right to receive client information.', isCorrect: false, justifiesChoice: 'A' },
          ...
          { id: 'j6', text: 'Contacting the father directly is appropriate because both parents always have equal rights to authorize disclosure.', isCorrect: false, justifiesChoice: 'D' },
      ...
      },
      {
        ...
        justifications: [
          ...
          { id: 'j4', text: 'Supporting the family is always appropriate and takes precedence over concerns about professional boundaries.', isCorrect: false, justifiesChoice: 'A' },
    ...
    questions: [
      {
        ...
        justifications: [
          ...
          { id: 'j7', text: 'Clinical judgment should always override data when the two are in conflict.', isCorrect: false, justifiesChoice: 'A' },
      ...
      },
      {
        ...
        justifications: [
          ...
          { id: 'j8', text: 'Extinction always produces rapid and permanent behavior reduction without temporary increases.', isCorrect: false, justifiesChoice: 'C' },
    ...
    questions: [
      ...
      },
      {
        ...
        justifications: [
          ...
          { id: 'j9', text: 'Written feedback is always sufficient for correcting implementation errors.', isCorrect: false, justifiesChoice: 'D' },
        ],
