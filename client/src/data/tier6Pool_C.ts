...
export const tier6Pool_C: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        letter: "B",
        text: "A strong functional relationship is demonstrated between the intervention and the reduction in tantrums."
      },
      {
        letter: "C",
  ...
  },
  {
    ...
    choices: [
      ...
      {
        letter: "B",
        text: "A lack of experimental control or inconsistent application of the intervention."
      },
      {
        letter: "C",
